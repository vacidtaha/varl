...
const slides = [
  ...
  { id: 2, label: "Slide 2", image: "/slide-2.jpg", source: "Robert Hooke, Drawings of Cork Structure, Micrographia, 1665", headline: "Health. Continuous.", description: "Our goal is not only to treat disease, but to make health sustainable and continuous.", link: "/health", linkLabel: "Health" },
  { id: 3, label: "Slide 3", image: "/slide-3.jpg", source: "Norman Borlaug standing in wheat field, 1960s", headline: "Production Is\nNot Enough.", description: "The future will not be built by producing more, but by transforming food into intelligent and resilient systems.", link: "/food", linkLabel: "Food" },
  { id: 4, label: "Slide 4", image: "/slide-4.jpeg", source: "The Pasteur Boom—High Times for Hydrophobists, 1885-Dec-23", headline: "Waiting Is Not\na Strategy.", description: "Disease research should no longer depend on multi-year cycles.", link: "/research", linkLabel: "Research" },
  { id: 5, label: "Slide 5", image: "/slide-5.jpeg", source: "Genevieve Work in Receiving Room at Dearborn laboratory facility, Circa 1924", headline: "A Better Science\nIs Possible.", description: "Varl accelerates discovery and transforms disease management into a systematic, continuous process.", link: "/science", linkLabel: "Science" },
];
