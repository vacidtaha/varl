...
export default function Dropdown({ label, options, value, onChange, variant = "filter", error }: DropdownProps) {
  ...
  return (
    <div ref={ref} className={`relative ${isFilter ? "flex-1" : "w-full"}`}>
      <button
        ...
        className={`flex w-full items-center justify-between text-base lg:text-sm ${
          isFilter
