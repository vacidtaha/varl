...
export default function SimulationMetrics() {
  ...
  return (
    <div ref={containerRef} className="flex h-full w-full flex-col justify-center gap-2.5 p-5 lg:gap-4 lg:p-8">
      <span className="mb-0.5 text-[9px] tracking-widest text-gray-400 lg:mb-1 lg:text-[10px]" style={{ fontWeight: 500 }}>PATHWAY ANALYSIS ENGINE</span>
      {metrics.map((m) => {
        ...
        return (
          <div key={m.label} className="flex flex-col gap-1">
            <div className="flex items-baseline justify-between">
              <span className="text-[9px] text-gray-500 lg:text-[11px] dark:text-gray-400">{m.label}</span>
              <span className="font-mono text-[10px] text-gray-700 lg:text-xs dark:text-gray-200" style={{ fontWeight: 500 }}>
                {display}{m.suffix}
              </span>
            </div>
            <div className="h-[4px] w-full overflow-hidden rounded-full bg-gray-100 lg:h-[5px] dark:bg-neutral-700">
              <div
