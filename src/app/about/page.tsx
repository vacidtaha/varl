  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        {/* Opening */}
        <section className="mx-auto max-w-3xl px-5 pb-16 pt-16 lg:px-8 lg:pb-24 lg:pt-32">
          <FadeIn>
        ...
        {/* Story */}
        <section className="mx-auto max-w-3xl px-5 pb-16 lg:px-8 lg:pb-32">
          <FadeIn>
        ...
        <section className="mx-auto max-w-3xl px-5 pb-16 lg:px-8 lg:pb-32">
          <FadeIn>
            <span className="text-xs tracking-widest text-gray-400 lg:text-sm" style={{ fontWeight: 500 }}>FOUNDERS</span>
            <h2 className="mt-3 text-2xl tracking-tight text-gray-900 lg:mt-4 lg:text-4xl dark:text-gray-100" style={{ fontWeight: 500 }}>
