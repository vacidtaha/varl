    ...
    <div className="flex min-h-screen flex-col">
      ...
      <section className="w-full" style={{ padding: "13px 13px 0" }}>
        <div className="rounded-2xl bg-gray-50 py-20 dark:bg-neutral-900">
          ...
          <FadeInStagger className="mx-auto mt-14 grid max-w-5xl grid-cols-4 gap-12 px-12" stagger={0.1}>
      ...
      <section className="w-full py-32" style={{ padding: "80px 13px" }}>
      ...
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-8 py-20">
        ...
        <FadeInStagger className="flex w-full gap-8" stagger={0.1}>
        ...
        <FadeInStagger className="flex w-full gap-8" stagger={0.08}>
