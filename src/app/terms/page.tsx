...
export const metadata: Metadata = {
  title: "Terms of Use",
  description: "Review the terms governing use of VARL's website, digital twin platform, API, and computational biology services, including user rights and legal obligations.",
  alternates: { canonical: `${SITE_URL}/terms` },
  openGraph: {
    title: "Terms of Use | VARL",
    description: "Review the terms governing use of VARL's website, digital twin platform, API, and computational biology services, including user rights and legal obligations.",
  },
};
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-4xl px-5 py-12 lg:px-8 lg:py-24">
          ...
          <div className="mt-10 flex flex-col gap-10 text-sm leading-relaxed text-gray-600 dark:text-gray-400 lg:mt-16 lg:gap-16 lg:text-base">
            ...
            {/* 2 */}
            <section>
              <h2 className="text-xl lg:text-2xl text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>2. Description of Services</h2>
              <p className="mt-4">
              ...
              <p className="mt-4">
                Access to the Services is granted on a case-by-case basis following VARL&apos;s review and approval. The specific features, capabilities, limitations, and terms applicable to your use are determined by the nature of your engagement and any supplemental agreements executed between you and VARL.
              </p>
              <p className="mt-4">
            ...
            {/* 3 */}
            <section>
              <h2 className="text-xl lg:text-2xl text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>3. Account Registration and Security</h2>
              <p className="mt-4">
            ...
            {/* 4 */}
            <section>
              <h2 className="text-xl lg:text-2xl text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>4. API Access and Usage</h2>
              <p className="mt-4">
                Access to, and use of, the VARL API is governed by the <Link href="/api-policy" className="underline underline-offset-2" style={{ color: "#06c", fontWeight: 500 }}>VARL API Usage Policy</Link>, which is incorporated herein by reference. By accessing or using the API, you agree to be bound by the API Usage Policy in its entirety, including all provisions relating to authentication, permitted use, prohibited activities, biosecurity obligations, dual-use research controls, monitoring and enforcement, and data handling.
              </p>
              <p className="mt-4">
                In the event of a conflict between these Terms of Use and the API Usage Policy with respect to API-specific matters, the API Usage Policy shall control.
              </p>
            </section>

            {/* 5 */}
            <section>
              <h2 className="text-xl lg:text-2xl text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>5. Permitted Use</h2>
              <p className="mt-4">
            ...
            {/* 6 */}
            <section>
              <h2 className="text-xl lg:text-2xl text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>6. Prohibited Conduct</h2>
              <p className="mt-4">
            ...
            {/* 7 */}
            <section>
              <h2 className="text-xl lg:text-2xl text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>7. Intellectual Property Rights</h2>

              <h3 className="mt-6 text-base lg:text-lg text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>7.1 VARL&apos;s Intellectual Property</h3>
              <p className="mt-3">
              ...
              <h3 className="mt-6 text-base lg:text-lg text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>7.2 Your Data</h3>
              <p className="mt-3">
              ...
              <h3 className="mt-6 text-base lg:text-lg text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>7.3 Output Ownership</h3>
              <p className="mt-3">
              ...
              <h3 className="mt-6 text-base lg:text-lg text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>7.4 Feedback</h3>
              <p className="mt-3">
            ...
            {/* 8 */}
            <section>
              <h2 className="text-xl lg:text-2xl text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>8. Payment and Billing</h2>
              <p className="mt-4">
            ...
            {/* 9 */}
            <section>
              <h2 className="text-xl lg:text-2xl text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>9. Confidentiality</h2>
              <p className="mt-4">
            ...
            {/* 10 */}
            <section>
              <h2 className="text-xl lg:text-2xl text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>10. Data Processing and Privacy</h2>
              <p className="mt-4">
                Your use of the Services is subject to VARL&apos;s <Link href="/privacy" className="underline underline-offset-2" style={{ color: "#06c", fontWeight: 500 }}>Privacy Policy</Link>, which is incorporated into these Terms by reference. By using the Services, you consent to the collection, processing, and storage of your information as described in the Privacy Policy.
              </p>
              <p className="mt-4">
            ...
            {/* 11 */}
            <section>
              <h2 className="text-xl lg:text-2xl text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>11. Term and Termination</h2>
              <p className="mt-4">
              ...
              <p className="mt-4">
                VARL may suspend your access to the Services immediately and without prior notice in circumstances involving an imminent security threat, suspected fraudulent or harmful activity, a confirmed or suspected credential compromise, or a legally binding directive from a law enforcement or regulatory authority. In such cases, VARL will notify you within 48 hours of the suspension, unless prohibited by law.
              </p>
              <p className="mt-4">
                For all other grounds — including violation of these Terms, non-payment of fees, or inactivity exceeding 12 months — VARL will provide written notice specifying the nature of the issue and allow 30 calendar days to cure the violation before terminating access. If the issue is not cured within the cure period, VARL may terminate access by providing 14 calendar days&apos; advance written notice. For API-specific termination procedures, the <Link href="/api-policy" className="underline underline-offset-2" style={{ color: "#06c", fontWeight: 500 }}>API Usage Policy</Link> (Section 11) shall control.
              </p>
              <p className="mt-4">
              ...
              <p className="mt-4">
                The following sections shall survive termination: Sections 6 (Prohibited Conduct), 7 (Intellectual Property Rights), 8 (Payment, to the extent of outstanding obligations), 9 (Confidentiality), 12 (Disclaimer of Warranties), 13 (Limitation of Liability), 14 (Indemnification), 15 (Export Compliance), 16 (Governing Law), and 17 (Dispute Resolution).
              </p>
            </section>

            {/* 12 */}
            <section>
              <h2 className="text-xl lg:text-2xl text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>12. Disclaimer of Warranties</h2>
              <p className="mt-4">
            ...
            {/* 13 */}
            <section>
              <h2 className="text-xl lg:text-2xl text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>13. Limitation of Liability</h2>
              <p className="mt-4">
            ...
            {/* 14 */}
            <section>
              <h2 className="text-xl lg:text-2xl text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>14. Indemnification</h2>
              <p className="mt-4">
              ...
              <p className="mt-4">
                VARL reserves the right, at your expense, to assume the exclusive defense and control of any matter subject to indemnification by you, and you agree to cooperate with our defense of such claims. You agree not to settle any such claim without VARL&apos;s prior written consent. For API-specific indemnification obligations — including liability arising from biosecurity violations, unauthorized clinical use, or data misuse through the API — the indemnification provisions of the <Link href="/api-policy" className="underline underline-offset-2" style={{ color: "#06c", fontWeight: 500 }}>API Usage Policy</Link> (Section 10) shall apply in addition to this section.
              </p>
            </section>

            {/* 15 */}
            <section>
              <h2 className="text-xl lg:text-2xl text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>15. Export Compliance</h2>
              <p className="mt-4">
            ...
            {/* 16 */}
            <section>
              <h2 className="text-xl lg:text-2xl text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>16. Governing Law</h2>
              <p className="mt-4">
            ...
            {/* 17 */}
            <section>
              <h2 className="text-xl lg:text-2xl text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>17. Dispute Resolution</h2>

              <h3 className="mt-6 text-base lg:text-lg text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>17.1 Mandatory Arbitration</h3>
              <p className="mt-3">
              ...
              <h3 className="mt-6 text-base lg:text-lg text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>17.2 Class Action Waiver</h3>
              <p className="mt-3">
              ...
              <h3 className="mt-6 text-base lg:text-lg text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>17.3 Equitable Relief</h3>
              <p className="mt-3">
            ...
            {/* 18 */}
            <section>
              <h2 className="text-xl lg:text-2xl text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>18. Modifications to Terms</h2>
              <p className="mt-4">
            ...
            {/* 19 */}
            <section>
              <h2 className="text-xl lg:text-2xl text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>19. General Provisions</h2>

              <h3 className="mt-6 text-base lg:text-lg text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>19.1 Entire Agreement</h3>
              <p className="mt-3">
                These Terms, together with the Privacy Policy, Cookie Policy, API Usage Policy, Disclaimer, and any applicable order forms, DPAs, BAAs, or supplemental agreements, constitute the entire agreement between you and VARL with respect to the subject matter hereof and supersede all prior or contemporaneous communications, whether oral or written.
              </p>

              <h3 className="mt-6 text-base lg:text-lg text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>19.2 Severability</h3>
              <p className="mt-3">
              ...
              <h3 className="mt-6 text-base lg:text-lg text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>19.3 Waiver</h3>
              <p className="mt-3">
              ...
              <h3 className="mt-6 text-base lg:text-lg text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>19.4 Assignment</h3>
              <p className="mt-3">
              ...
              <h3 className="mt-6 text-base lg:text-lg text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>19.5 Force Majeure</h3>
              <p className="mt-3">
              ...
              <h3 className="mt-6 text-base lg:text-lg text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>19.6 Notices</h3>
              <p className="mt-3">
                All notices required or permitted under these Terms shall be in writing and shall be deemed given when delivered personally, sent by certified mail (return receipt requested), or sent by email to: (a) for notices to VARL, legal@varl.net; (b) for notices to you, the email address associated with your account.
              </p>
            </section>

            {/* 20 */}
            <section>
              <h2 className="text-xl lg:text-2xl text-gray-900 dark:text-gray-100" style={{ fontWeight: 500 }}>20. Contact Information</h2>
              <p className="mt-4">
              ...
              <div className="mt-6 rounded-xl bg-gray-50 p-5 dark:bg-neutral-800 lg:p-8">
                <div className="flex flex-col gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-gray-900 dark:text-gray-100">legal@varl.net</p>
                  </div>
                  <div>
