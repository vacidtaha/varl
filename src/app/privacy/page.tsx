...
export const metadata: Metadata = {
  ...
  description: "VARL's privacy policy: how we collect, use, store, and protect your personal data in compliance with GDPR and international data protection regulations.",
  alternates: { canonical: `${SITE_URL}/privacy` },
  openGraph: {
    title: "Privacy Policy | VARL",
    description: "VARL's privacy policy: how we collect, use, store, and protect your personal data in compliance with GDPR and international data protection regulations.",
  },
};
    ...
    <div className="flex min-h-screen flex-col bg-white dark:bg-neutral-900">
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-4xl px-5 py-12 lg:px-8 lg:py-24">
          ...
          <h1 className="text-3xl tracking-tight text-gray-900 dark:text-gray-100 lg:text-5xl" style={{ fontWeight: 500 }}>
            Privacy Policy
          </h1>
          ...
          <div className="mt-10 flex flex-col gap-10 text-sm leading-relaxed text-gray-600 dark:text-gray-400 lg:mt-16 lg:gap-16 lg:text-base">
            ...
            {/* 2 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>2. Information We Collect</h2>

              <h3 className="mt-6 text-base text-gray-900 dark:text-gray-100 lg:text-lg" style={{ fontWeight: 500 }}>2.1 Information You Provide Directly</h3>
              <p className="mt-3">
              ...
              <h3 className="mt-8 text-base text-gray-900 dark:text-gray-100 lg:text-lg" style={{ fontWeight: 500 }}>2.2 Information Collected Automatically</h3>
              <p className="mt-3">
              ...
              <h3 className="mt-8 text-base text-gray-900 dark:text-gray-100 lg:text-lg" style={{ fontWeight: 500 }}>2.3 Information from Third Parties</h3>
              <p className="mt-3">
              ...
              <h3 className="mt-8 text-base text-gray-900 dark:text-gray-100 lg:text-lg" style={{ fontWeight: 500 }}>2.4 Sensitive and Regulated Data</h3>
              <p className="mt-3">
              ...
              <p className="mt-3">
                VARL performs automated dual-use data screening on biological data submitted through the API. This screening is designed to identify data patterns, query sequences, or molecular structures that may be associated with dual-use research of concern — including pathogen genomics, toxin synthesis pathways, antimicrobial resistance markers, and gain-of-function modeling inputs. Data flagged by this system is subject to manual review by VARL&apos;s Biosecurity and Ethics Board before processing proceeds. This screening is conducted solely for biosecurity purposes and does not involve the use of submitted data for any commercial, marketing, or model training purpose. For more details on API-specific data handling obligations, please refer to the <Link href="/api-policy" className="underline underline-offset-2" style={{ color: "#06c", fontWeight: 500 }}>API Usage Policy</Link>.
              </p>
            </section>

            {/* 3 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>3. How We Use Your Information</h2>
              <p className="mt-4">
            ...
            {/* 4 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>4. Legal Basis for Processing (GDPR)</h2>
              <p className="mt-4">
            ...
            {/* 5 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>5. Information Sharing and Disclosure</h2>
              <p className="mt-4">
              ...
              <p className="mt-4">
                Except as required by valid legal process, court order, or binding governmental directive, VARL will not share, disclose, or provide access to partner-specific proprietary data, biological datasets, simulation results, or research outputs to any third party — including affiliated entities, investors, and governmental bodies — without the express written authorization of the data owner.
              </p>
            </section>

            {/* 6 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>6. Data Retention</h2>
              <p className="mt-4">
              ...
              <ul className="mt-4 flex flex-col gap-3 pl-6">
                ...
                <li className="list-disc"><strong className="text-gray-900 dark:text-gray-100">API Usage Logs:</strong> Retained for 7 years from the date of the request for audit, compliance, and security investigation purposes, as detailed in the <Link href="/api-policy" className="underline underline-offset-2" style={{ color: "#06c", fontWeight: 500 }}>API Usage Policy</Link>.</li>
            ...
            {/* 7 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>7. Security of Biological and Health Data</h2>
              <p className="mt-4">
              ...
              <ul className="mt-4 flex flex-col gap-3 pl-6">
                ...
                <li className="list-disc">All access events are logged in immutable audit trails that are retained for a minimum of 7 years.</li>
              ...
              <p className="mt-4">
                VARL undergoes annual SOC 2 Type II audits and maintains ISO 27001 certification for its information security management system. Audit reports are available to partners and regulators upon request under NDA. For full details on certifications, audit history, and compliance frameworks, see the <Link href="/compliance" className="underline underline-offset-2" style={{ color: "#06c", fontWeight: 500 }}>Compliance</Link> page.
              </p>
            </section>

            {/* 8 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>8. Your Rights</h2>
              <p className="mt-4">
              ...
              <p className="mt-4">
                To exercise any of these rights, please contact us at <span className="text-gray-900 dark:text-gray-100">privacy@varl.net</span>. We will respond to all legitimate requests within 30 days (as required by the GDPR). For California residents exercising rights under the CCPA/CPRA, the response period is 45 days as described in Section 12. We may request verification of your identity before processing your request.
              </p>
            </section>

            {/* 9 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>9. International Data Transfers</h2>
              <p className="mt-4">
              ...
              <p className="mt-4">
                For transfers to the United States, VARL relies on the EU-U.S. Data Privacy Framework and, where that framework does not apply, SCCs with additional technical and organizational safeguards. You may request a copy of the applicable transfer mechanism by contacting privacy@varl.net.
              </p>
            </section>

            {/* 10 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>10. Cookies and Tracking Technologies</h2>
              <p className="mt-4">
            ...
            <section>
              ...
              <p className="mt-4">
                To exercise these rights, please contact us at privacy@varl.net or submit a request through our website. We will verify your identity before processing your request and respond within 45 days.
              </p>
            </section>

            {/* 13 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>13. Third-Party Links</h2>
              <p className="mt-4">
            ...
            {/* 14 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>14. Changes to This Policy</h2>
              <p className="mt-4">
            ...
            {/* 15 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>15. Limitation of Liability</h2>
              <p className="mt-4">
            ...
            {/* 16 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>16. Governing Law and Dispute Resolution</h2>
              <p className="mt-4">
            ...
            {/* 17 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>17. Contact Information</h2>
              <p className="mt-4">
              ...
              <div className="mt-6 rounded-xl bg-gray-50 p-5 dark:bg-neutral-800 lg:p-8">
                <div className="flex flex-col gap-4 text-sm">
                  ...
                  <div>
                    <span className="text-xs tracking-wide text-gray-400" style={{ fontWeight: 500 }}>EU Representative (GDPR Article 27)</span>
                    <p className="mt-1 text-gray-900 dark:text-gray-100">VARL is in the process of appointing an EU representative in accordance with GDPR Article 27. Until the appointment is finalized, EU/EEA data subjects may direct inquiries regarding their personal data rights to <a href="mailto:privacy@varl.net" className="underline underline-offset-2" style={{ color: "#06c", fontWeight: 500 }}>privacy@varl.net</a>, and VARL will respond within the statutory timelines applicable under the GDPR. This section will be updated with the representative&apos;s name and contact details upon appointment.</p>
                  </div>
                </div>
              </div>
            </section>
