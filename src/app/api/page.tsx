...
const TextParticles = dynamic(() => import("@/components/TextParticles"), { ssr: false });
...
export default function ApiDocsPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white dark:bg-black">
      <h1 className="sr-only">VARL API Documentation — Digital Twins, Simulations, Biomarkers, and Predictions</h1>
      {/* Mobile: API requires desktop */}
      <div className="fixed inset-0 z-[9999] flex flex-col bg-black lg:hidden" style={{ touchAction: "none" }}>
        <div className="absolute inset-0">
          <TextParticles text="API" />
        </div>
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-transparent via-black/40 to-black" />

        <div className="pointer-events-none relative z-10 flex justify-center pt-8">
          <Image src="/header-logo.png" alt="VARL" width={75} height={24} className="h-6 w-auto invert" />
        </div>

        <div className="flex-1" />

        <div className="relative z-10 flex flex-col gap-4 px-8 pb-8">
          <h2 className="text-3xl leading-tight tracking-tight" style={{ fontWeight: 700 }}>
            <span className="bg-gradient-to-r from-blue-400 via-cyan-400 to-teal-400 bg-clip-text text-transparent">
              Desktop required<br />for API docs.
            </span>
          </h2>
          <p className="max-w-sm text-sm leading-relaxed text-white/40">
            The API documentation includes interactive code editors, request builders, and technical reference tables that require a desktop browser.
          </p>
          <p className="text-xs text-white/25">
            Please visit varl.net/api on a desktop computer.
          </p>
          <a
            href="/"
            className="mt-2 inline-flex w-fit items-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm text-black transition-colors hover:bg-white/90"
          ...
          <div>
            ...
            <section id="overview" className="scroll-mt-16 pb-20">
              ...
              <div className="mt-4 bg-gray-900 px-6 py-4 dark:bg-neutral-950">
                <code className="font-mono text-sm text-green-400">https://api.varl.net/v1</code>
              </div>
...
{`{
  ...
  "request_id": "req_v4rl_7k2m9n"
              ...
              <div className="mt-6 grid grid-cols-3 gap-4">
                {[
                  { lang: "Python", label: "varl-sdk" },
                  { lang: "TypeScript", label: "@varl/sdk" },
                  { lang: "R", label: "varl" },
                ].map((sdk) => (
                  <div key={sdk.lang} className="bg-gray-50 p-5 dark:bg-neutral-900">
                    ...
                    <p className="mt-1 font-mono text-xs text-gray-400">{sdk.label}</p>
                    <span className="mt-3 inline-block rounded-full bg-amber-100 px-2.5 py-0.5 font-mono text-[10px] text-amber-700 dark:bg-amber-500/10 dark:text-amber-400">
                      Coming soon
                    </span>
                  </div>
                ))}
              ...
              <p className="mt-4 text-base leading-relaxed text-gray-600 dark:text-gray-400">
                Current API uptime is 99.97%. System status, incident reports, and scheduled maintenance windows are published at <span className="font-mono text-sm text-gray-700 dark:text-gray-300">status.varl.net</span>. Subscribe to receive real-time notifications via email or webhook.
              </p>
            </section>
            ...
            <section id="authentication" className="scroll-mt-16 pb-20">
              ...
              <div className="mt-4 bg-gray-900 p-6 dark:bg-neutral-950">
                ...
                <pre className="font-mono text-sm leading-relaxed">
                  <span className="text-green-400">curl</span> <span className="text-white">-X GET https://api.varl.net/v1/twins</span> <span className="text-white">\</span>{"\n"}
  ...
  "cancelled_at": "2026-02-14T10:16:45Z"
              ...
              <div className="mt-8 flex flex-col gap-4">
                <div className="flex items-start gap-4 bg-gray-50 p-5 dark:bg-neutral-900">
                  ...
                  <p className="text-sm leading-relaxed text-gray-500 dark:text-gray-400">Simulation is accepted and waiting for compute resources. Queue time depends on cluster load. Typical wait: under 5 seconds.</p>
                </div>
                <div className="flex items-start gap-4 bg-gray-50 p-5 dark:bg-neutral-900">
  ...
  "request_id": "req_v4rl_8n3k7m"
              ...
              <div className="mt-4 bg-gray-900 p-6 dark:bg-neutral-950">
                ...
                <pre className="font-mono text-sm leading-relaxed">
                  ...
                  <span className="text-white">{"  "}</span><span className="text-green-300">&quot;https://upload.varl.net/ds_pd_3m7k1x?token=...&quot;</span>
                </pre>
              </div>
                ...
                <table className="w-full text-left text-sm">
                  <thead>
                    <tr className="border-b border-gray-200 dark:border-neutral-800">
                      ...
                      <th className="pb-3 text-xs text-gray-400" style={{ fontWeight: 500 }}>Limit</th>
                    </tr>
                  </thead>
                  <tbody className="text-gray-600 dark:text-gray-400">
                    <tr className="border-b border-gray-100 dark:border-neutral-800/50">
                      <td className="py-3 pr-4 text-xs">Read operations (GET)</td>
                      <td className="py-3 font-mono text-xs">600 RPM</td>
                    </tr>
                    <tr className="border-b border-gray-100 dark:border-neutral-800/50">
                    ...
                    <tr className="border-b border-gray-100 dark:border-neutral-800/50">
                      ...
                      <td className="py-3 font-mono text-xs">50 RPM</td>
                    </tr>
                    <tr className="border-b border-gray-100 dark:border-neutral-800/50">
                      <td className="py-3 pr-4 text-xs">Predictions</td>
                      <td className="py-3 font-mono text-xs">100 RPM</td>
                    </tr>
                    <tr className="border-b border-gray-100 dark:border-neutral-800/50">
                      <td className="py-3 pr-4 text-xs">Dataset uploads</td>
                      <td className="py-3 font-mono text-xs">100 RPD</td>
                    </tr>
                    <tr>
                      <td className="py-3 pr-4 text-xs">Batch operations</td>
                      <td className="py-3 font-mono text-xs">20 RPM</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="mt-8 flex flex-col gap-3">
                ...
                <div className="flex items-start gap-4 bg-gray-50 p-5 dark:bg-neutral-900">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs leading-relaxed text-gray-500 dark:text-gray-400">The platform is temporarily unavailable due to maintenance or capacity constraints. Retry after the duration specified in the <code className="text-gray-700 dark:text-gray-300">Retry-After</code> header. Check <span className="font-mono text-gray-700 dark:text-gray-300">status.varl.net</span> for incident updates.</p>
                  </div>
                </div>
              </div>
