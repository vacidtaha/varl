...
export const metadata: Metadata = {
  title: "Compliance",
  description: "VARL's regulatory compliance framework: HIPAA, GDPR, GxP, ISO 27001, and SOC 2 certifications for handling sensitive biological and patient data.",
  alternates: { canonical: `${SITE_URL}/compliance` },
  openGraph: {
    title: "Compliance | VARL",
    description: "VARL's regulatory compliance framework: HIPAA, GDPR, GxP, ISO 27001, and SOC 2 certifications for handling sensitive biological and patient data.",
  },
};
...
export default function CompliancePage() {
  return (
    <div className="flex min-h-screen flex-col bg-white dark:bg-neutral-900">
      ...
      {/* Hero */}
      <div className="relative h-[200px] w-full overflow-hidden lg:h-[520px]">
        <Image
          src="/uyum.webp"
          alt="Compliance"
          fill
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-4xl px-5 py-12 lg:px-8 lg:py-24">
          ...
          <h2 className="text-2xl tracking-tight text-gray-900 dark:text-gray-100 lg:text-4xl" style={{ fontWeight: 500 }}>
            Our Position
          </h2>
          ...
          <div className="mt-10 flex flex-col gap-10 text-sm leading-relaxed text-gray-600 dark:text-gray-400 lg:mt-16 lg:gap-16 lg:text-base">
            ...
            {/* 1 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>Regulatory Frameworks</h2>
              <p className="mt-4">
              ...
              <div className="mt-8 flex flex-col gap-6">
                <div className="rounded-xl bg-gray-50 p-5 dark:bg-neutral-800 lg:p-8">
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                    VARL implements administrative, physical, and technical safeguards as required by the HIPAA Privacy Rule, Security Rule, and Breach Notification Rule. All partners processing protected health information (PHI) through our platform are required to execute a Business Associate Agreement (BAA) prior to data transmission. Our infrastructure supports HIPAA-compliant data handling, including encryption at rest and in transit, access controls, audit logging, and workforce training. For details on how we handle PHI and biological data, see our <Link href="/privacy" className="underline underline-offset-2" style={{ color: "#06c", fontWeight: 500 }}>Privacy Policy</Link> (Section 7).
                  </p>
                </div>
            ...
            {/* 2 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>Certifications &amp; Audits</h2>
              <p className="mt-4">
                VARL is building its infrastructure, processes, and controls to meet the following industry-standard certification requirements:
              </p>
              ...
              <div className="mt-8 flex flex-col">
                <div className="flex gap-8 border-t border-gray-200 py-8 dark:border-neutral-800">
                  ...
                  <div>
                    ...
                    <span className="mt-2 inline-block text-xs text-gray-400">Aligned with SOC 2 Type II standards · Annual audit cycle</span>
                  </div>
                </div>
                <div className="flex gap-8 border-t border-gray-200 py-8 dark:border-neutral-800">
                  ...
                  <div>
                    ...
                    <span className="mt-2 inline-block text-xs text-gray-400">Aligned with ISO 27001 standards · Certification in progress</span>
                  </div>
                </div>
                <div className="flex gap-8 border-t border-gray-200 py-8 dark:border-neutral-800">
                  ...
                  <div>
                    ...
                    <span className="mt-2 inline-block text-xs text-gray-400">Aligned with ISO 27701 standards · Certification in progress</span>
                  </div>
                </div>
                <div className="flex gap-8 border-t border-b border-gray-200 py-8 dark:border-neutral-800">
                  ...
                  <div>
                    ...
                    <span className="mt-2 inline-block text-xs text-gray-400">Aligned with CSA STAR Level 2 requirements</span>
                  </div>
                </div>
              </div>
            </section>
            ...
            {/* 3 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>Data Security</h2>
              <p className="mt-4">
              ...
              <div className="mt-8 grid grid-cols-2 gap-6">
                ...
                <div className="rounded-xl bg-gray-50 p-6 dark:bg-neutral-800">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-gray-500 dark:text-gray-400">Immutable audit trails for all data access events, API calls, configuration changes, and administrative actions. Logs are retained for a minimum of 7 years and are protected against tampering through cryptographic chaining.</p>
                </div>
                <div className="rounded-xl bg-gray-50 p-6 dark:bg-neutral-800">
            ...
            {/* 4 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>Biosecurity &amp; Ethical Oversight</h2>
              <p className="mt-4">
                Given the dual-use potential of biological intelligence technologies, VARL maintains a dedicated Biosecurity and Ethics Board that reviews all new capabilities, partnership applications, and API access requests for potential misuse risk. The board comprises internal scientists, external advisors, and independent bioethics experts. For detailed prohibited use categories, biosecurity obligations, and enforcement mechanisms applicable to API users, see the <Link href="/api-policy" className="underline underline-offset-2" style={{ color: "#06c", fontWeight: 500 }}>API Usage Policy</Link>.
              </p>
              <p className="mt-4">
              ...
              <ul className="mt-4 flex flex-col gap-3 pl-6">
                ...
                <li className="list-disc">Automated flagging and manual review of all gain-of-function modeling requests — including simulations involving enhanced transmissibility, virulence, or immune evasion — regardless of the applicant&apos;s stated research purpose, in alignment with the U.S. P3CO framework and equivalent international oversight mechanisms</li>
                <li className="list-disc">Absolute prohibition on API usage for genetic targeting of populations — any request using biomarker detection, genomic analysis, or predictive endpoints to identify population-specific vulnerabilities based on ancestry, ethnicity, or heritable characteristics is rejected and reported</li>
                <li className="list-disc">Alignment with international biosecurity standards including the Cartagena Protocol on Biosafety, WHO Laboratory Biosafety Manual (4th edition), the Australia Group export control guidelines, and the Wassenaar Arrangement on dual-use technologies</li>
                <li className="list-disc">Mandatory dual-use risk scoring for all API requests involving Select Agents and Toxins (as defined by the U.S. Federal Select Agent Program), BSL-3/BSL-4 pathogens, or CWC-scheduled chemicals, with automatic escalation to human reviewers when risk thresholds are exceeded</li>
              </ul>
            </section>

            {/* 5 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>Vendor &amp; Supply Chain Management</h2>
              <p className="mt-4">
              ...
              <p className="mt-4">
                A list of our subprocessors is available upon request and is updated whenever a new subprocessor is engaged. Partners with contractual notification requirements are informed at least 30 days before any subprocessor change takes effect. For information on how we share data with third parties and service providers, see our <Link href="/privacy" className="underline underline-offset-2" style={{ color: "#06c", fontWeight: 500 }}>Privacy Policy</Link> (Section 5).
              </p>
            </section>

            {/* 6 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>Employee Training &amp; Awareness</h2>
              <p className="mt-4">
            ...
            {/* 7 */}
            <section>
              <h2 className="text-xl text-gray-900 dark:text-gray-100 lg:text-2xl" style={{ fontWeight: 500 }}>Requesting Compliance Documentation</h2>
              <p className="mt-4">
              ...
              <div className="mt-6 rounded-xl bg-gray-50 p-5 dark:bg-neutral-800 lg:p-8">
                <div className="flex flex-col gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-gray-900 dark:text-gray-100">compliance@varl.net</p>
                  </div>
                  <div>
