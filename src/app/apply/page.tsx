              ...
              <div className="mt-8 flex flex-col gap-4">
                <label className="flex items-start gap-3">
                  ...
                  <span className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                    I have read and agree to VARL&apos;s <Link href="/privacy" className="underline">Privacy Policy</Link> and consent to the collection and processing of my personal data for recruitment purposes. *
                  </span>
                </label>
                <label className="flex items-start gap-3">
                  <input type="checkbox" className="mt-1 h-4 w-4 accent-green-500 dark:accent-green-400" />
