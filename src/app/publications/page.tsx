...
const publications = [
  ...
  },
  {
    ...
    doi: "10.1016/j.cels.2025.11.003",
  ...
  },
  {
    ...
    journal: "Nature Food",
    doi: "10.1038/s43016-025-01087-3",
  ...
  },
  {
    ...
    journal: "Proceedings of ISMB 2025",
    doi: "10.1093/bioinformatics/btv2025",
  ...
  },
  {
    ...
    doi: "10.1038/s41587-025-02341-8",
  ...
  },
  {
    ...
    doi: "10.1021/acs.jmedchem.5c00891",
  ...
  },
  {
    ...
    doi: "10.1038/s41893-025-01234-5",
        ...
        <div className="mx-auto w-full max-w-5xl px-8 py-16">
          ...
          {Object.entries(grouped).map(([yr, items], gi) => (
            <div key={yr}>
              ...
              {items.map((pub, i) => (
                <FadeIn key={pub.doi}>
                  <a href={`https://doi.org/${pub.doi}`} target="_blank" rel="noopener noreferrer" className="group block py-8">
                    <div className="flex items-start justify-between gap-8">
                      <div className="flex flex-1 flex-col gap-2">
                        ...
                        <p className="text-sm text-gray-500 transition-colors group-hover:text-gray-700 dark:text-gray-400 dark:group-hover:text-gray-200">{pub.authors}</p>
                        <p className="text-sm italic text-gray-400 transition-colors group-hover:text-gray-600 dark:group-hover:text-gray-300">{pub.journal}</p>
                        <p className="mt-2 text-sm leading-relaxed text-gray-500 transition-colors group-hover:text-gray-700 dark:text-gray-400 dark:group-hover:text-gray-200">
                          {pub.abstract}
                        </p>
                      </div>
                      <span className="mt-1 shrink-0 text-sm text-gray-400 transition-colors group-hover:text-black dark:group-hover:text-white" style={{ fontWeight: 450 }}>
                        DOI &rarr;
                      </span>
                    </div>
                  </a>
